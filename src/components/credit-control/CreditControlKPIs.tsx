...
interface CreditControlKPIsProps {
  dashboardStats: {
    overdueTotal: number;
    legalTotal: number;
    ...
    overdueSimplicity: number;
    overdueOldestDays: number;
    legalList: any[];
    next7DaysTotal: number;
    thisMonthDirect: number;
    thisMonthSimplicity: number;
    thisMonthList: any[];
    nextMonthTotal: number;
    nextMonthDirect: number;
    nextMonthSimplicity: number;
    nextMonthList: any[];
    disputedList: any[];
    disputedTotal: number;
  };
  debtorsOver60: any[];
  collapseAnalytics: boolean;
  setCollapseAnalytics: (val: boolean) => void;
  expandDebtors60: boolean;
  setExpandDebtors60: (val: boolean) => void;
