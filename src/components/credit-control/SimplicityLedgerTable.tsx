...
interface SimplicityLedgerTableProps {
  ...
  handleMoveInvoiceToWeek: (invoiceId: string, targetWeekDate: string) => void;
  upcomingFridays: string[];
  simplicityPriorWeeks: any[];
  simplicityActiveWeeks: WeekGroup[];
  simplicityPaid: any[];
  simplicityLegal: any[];
  simplicityOverdue: any[];
  sortBy: string;
  sortOrder: 'asc' | 'desc';
...
export default function SimplicityLedgerTable({
  ...
  const renderSimplicityTable = (title: string, list: any[], headerBg: string, titleColor: string, statusInfo: string, isWeekGroup = false, weekDateStr = '') => {
